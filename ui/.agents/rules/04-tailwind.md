...
description: Tailwind CSS utility-first styling patterns, responsive design, dark mode, custom theme configuration, and component class organization best practices.
globs: ["**/*.tsx", "**/*.css"]
---
