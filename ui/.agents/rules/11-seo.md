...
description: SEO best practices for Next.js including Metadata API, Open Graph, Twitter Cards, structured data (JSON-LD), sitemap, robots.txt, and Core Web Vitals optimization.
