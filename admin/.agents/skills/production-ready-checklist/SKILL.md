...
- [ ] **Sau verify:** kill dev process, giải phóng PORT
...
Chạy thêm nếu có: `npm run lint`, `npm run type-check`
...
- [ ] Đã chạy `npm run lint` pass (nếu có)
...
- [ ] Repo `ui/`: xem `25-multi-step-apply-forms.mdc` khi sửa `app/apply/`
