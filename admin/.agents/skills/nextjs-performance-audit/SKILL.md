...
// ✅ Config được khuyến nghị
cacheComponents: true,                     // [TRADE-OFF] Chấp nhận tốn RAM ở môi trường dev để đổi lấy hiệu năng vượt trội ở Production
experimental: {}
```
...
| `application-code` > 400ms cho trang mock | `cacheComponents: true` | CHẤP NHẬN TRADE-OFF: Giữ nguyên để có hiệu năng tốt ở Production |
