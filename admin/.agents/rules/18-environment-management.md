...
description: Environment variable management — .env files, NEXT_PUBLIC_ prefix, Zod validation at startup, never use process.env directly outside config files.
globs: "**/*.ts"
---
