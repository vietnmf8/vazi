...
const RechartsPrimitive = {
  ResponsiveContainer: dynamic<any>(() => import("recharts").then((mod) => mod.ResponsiveContainer as any), { ssr: false }),
  Tooltip: dynamic<any>(() => import("recharts").then((mod) => mod.Tooltip as any), { ssr: false }),
  Legend: dynamic<any>(() => import("recharts").then((mod) => mod.Legend as any), { ssr: false })
}
