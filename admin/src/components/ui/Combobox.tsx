...
export function Combobox({
 ...
 // Native scroll is used instead of custom scroll
 ...
 // 2. Native scrollbar will automatically show
 }, 10);
 
 return () => clearTimeout(timer);
 }, [open, value, inputValue]);
 // No drag listeners needed
 ...
 !opt.disabled && "hover:bg-(--color-surface-elevated)",
 opt.disabled && "opacity-50 cursor-not-allowed pointer-events-auto",
 value === opt.value &&
 "font-extrabold",
 )}
 >
