...
6. **NGHIÊM CẤM TUYỆT ĐỐI** tự ý chạy các lệnh phá hủy dữ liệu bao gồm: `prisma migrate reset`, `drop database`, `delete`, `truncate` hoặc bất kỳ hành động xóa/reset/làm sạch database/mã nguồn nào nếu chưa có sự ĐỒNG Ý và XÁC NHẬN bằng văn bản rõ ràng từ người dùng. Luôn luôn hỏi ý kiến trước khi thực hiện các lệnh có nguy cơ mất mát dữ liệu hoặc thay đổi cấu trúc hệ thống lớn.
