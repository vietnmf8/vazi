...
> ⚠️ **Priority note:** This is a generic ECC patterns reference. When any guidance here conflicts with `backend-dev-guidelines`, always defer to `backend-dev-guidelines` — it is the canonical standard for this project.
