...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    update: { password: hashedPassword, role: 'ADMIN', fullName: 'VietNM (Super Admin)', emailVerified: new Date() },
    create: {
  ...
  await prisma.user.upsert({
    ...
    update: { password: hashedPassword, role: 'ADMIN', fullName: 'VietNM (Admin)', emailVerified: new Date() },
    create: {
      email: adminEmail,
