...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    update: { password: hashedPassword, role: 'ADMIN', fullName: 'VietNM (Super Admin)', emailVerified: new Date(), phone: '0123456789' },
    create: {
  ...
  await prisma.user.upsert({
    ...
    update: { password: hashedPassword, role: 'ADMIN', fullName: 'VietNM (Admin)', emailVerified: new Date(), phone: '0987654321' },
    create: {
      email: adminEmail,
